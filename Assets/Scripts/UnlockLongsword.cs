...
public class UnlockLongsword : MonoBehaviour
{
    ...
    IEnumerator ShowUI(){
        ...
        InventoryController.Instance.longSword.color = Color.white;
        ...
        PlayerController.Instance.unlockedLong = true;
        PlayerController.Instance.weaponList[1] = PlayerController.Instance.unlockedLong;
